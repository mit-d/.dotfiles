# Black Metal (Marduk) -- generated, do not edit.
#
# Source: tinted-theming/schemes base16/black-metal-marduk.yaml
...
#
# To change a value, add ../overrides/black-metal-marduk.nix. Edits here are lost on the
# next run.

{
  name = "black-metal-marduk";
  displayName = "Black Metal (Marduk)";
  author = "metalelf0 (https://github.com/metalelf0)";
  variant = "dark";
  version = "3.1.0";
