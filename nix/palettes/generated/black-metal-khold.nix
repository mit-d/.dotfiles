# Black Metal (Khold) -- generated, do not edit.
#
# Source: tinted-theming/schemes base16/black-metal-khold.yaml
...
#
# To change a value, add ../overrides/black-metal-khold.nix. Edits here are lost on the
# next run.

{
  name = "black-metal-khold";
  displayName = "Black Metal (Khold)";
  author = "metalelf0 (https://github.com/metalelf0)";
  variant = "dark";
  version = "3.1.0";
