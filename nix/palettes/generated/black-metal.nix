# Black Metal -- generated, do not edit.
#
# Source: tinted-theming/schemes base16/black-metal.yaml
...
#
# To change a value, add ../overrides/black-metal.nix. Edits here are lost on the
# next run.
