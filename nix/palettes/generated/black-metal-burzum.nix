# Black Metal (Burzum) -- generated, do not edit.
#
# Source: tinted-theming/schemes base16/black-metal-burzum.yaml
...
#
# To change a value, add ../overrides/black-metal-burzum.nix. Edits here are lost on the
# next run.

{
  name = "black-metal-burzum";
  displayName = "Black Metal (Burzum)";
  author = "metalelf0 (https://github.com/metalelf0)";
  variant = "dark";
  version = "3.1.0";
