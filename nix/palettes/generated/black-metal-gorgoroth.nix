# Black Metal (Gorgoroth) -- generated, do not edit.
#
# Source: tinted-theming/schemes base16/black-metal-gorgoroth.yaml
...
#
# To change a value, add ../overrides/black-metal-gorgoroth.nix. Edits here are lost on the
# next run.

{
  name = "black-metal-gorgoroth";
  displayName = "Black Metal (Gorgoroth)";
  author = "metalelf0 (https://github.com/metalelf0)";
  variant = "dark";
  version = "3.1.0";
