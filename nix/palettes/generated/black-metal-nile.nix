# Black Metal (Nile) -- generated, do not edit.
#
# Source: tinted-theming/schemes base16/black-metal-nile.yaml
...
#
# To change a value, add ../overrides/black-metal-nile.nix. Edits here are lost on the
# next run.

{
  name = "black-metal-nile";
  displayName = "Black Metal (Nile)";
  author = "metalelf0 (https://github.com/metalelf0)";
  variant = "dark";
  version = "3.1.0";
