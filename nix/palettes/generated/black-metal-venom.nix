# Black Metal (Venom) -- generated, do not edit.
#
# Source: tinted-theming/schemes base16/black-metal-venom.yaml
...
#
# To change a value, add ../overrides/black-metal-venom.nix. Edits here are lost on the
# next run.

{
  name = "black-metal-venom";
  displayName = "Black Metal (Venom)";
  author = "metalelf0 (https://github.com/metalelf0)";
  variant = "dark";
  version = "3.1.0";
