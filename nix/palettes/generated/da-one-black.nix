# Da One Black -- generated, do not edit.
#
# Source: tinted-theming/schemes base16/da-one-black.yaml
...
#
# To change a value, add ../overrides/da-one-black.nix. Edits here are lost on the
# next run.

{
  name = "da-one-black";
  displayName = "Da One Black";
  author = "NNB (https://github.com/NNBnh)";
  variant = "dark";
  version = "3.1.0";
