# Soft Server -- generated, do not edit.
#
# Source: tinted-theming/schemes base16/soft-server.yaml
...
#
# To change a value, add ../overrides/soft-server.nix. Edits here are lost on the
# next run.
