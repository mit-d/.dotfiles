# Black Metal (Immortal) -- generated, do not edit.
#
# Source: tinted-theming/schemes base16/black-metal-immortal.yaml
...
#
# To change a value, add ../overrides/black-metal-immortal.nix. Edits here are lost on the
# next run.
